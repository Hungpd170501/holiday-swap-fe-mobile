...
function Navigation() {
    ...
    useEffect(() => {
        if (user && user.access_token) {
            ...
            stompContext.newStompClient("https:///api.holiday-swap.click/websocket", user.access_token, dispatch);
        }
    }, [user]);
            ...
            <Stack.Navigator screenOptions={{headerShown: false}}>
                {authen ? (
                    <Fragment>
                        ...
                        />
                        {withSocket(<Stack.Screen name="ChatScreen" component={ChatScreen}/>)}
                    ...
                    <Fragment>
                        ...
                        <Stack.Screen name="HelpCenter" component={HelpCenter}/>
                        <Stack.Screen name="Wallet" component={Wallet}/>
                        {withSocket(<Stack.Screen name="Notification" component={NotificationScreen}/>)}
                        <Stack.Screen
                            name="ManageRevervation"
                            component={ManageRevervation}
                        />
